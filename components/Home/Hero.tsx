  ...
  return (
    <>
      <section className="relative mx-auto flex flex-col items-center justify-center py-8 sm:py-16 lg:py-24 transition-all  overflow-hidden w-full">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-white to-rose-50/30 -z-10"></div>
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-rose-100/40 via-transparent to-transparent -z-10"></div>
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-violet-100/30 via-transparent to-transparent -z-10"></div>

        {/* Floating Elements */}
        <div className="absolute top-20 left-10 w-64 h-64 bg-gradient-to-r from-rose-200/20 to-pink-200/20 rounded-full blur-3xl animate-pulse -z-10"></div>
        <div className="absolute bottom-20 right-10 w-80 h-80 bg-gradient-to-r from-violet-200/15 to-purple-200/15 rounded-full blur-3xl animate-pulse delay-1000 -z-10"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-blue-200/10 to-cyan-200/10 rounded-full blur-3xl animate-pulse delay-500 -z-10"></div>
        ...
        <div className="relative mb-8 group">
          ...
          <div className="relative">
            <Badge className="relative px-8 py-3 bg-white/90 backdrop-blur-sm border border-white/40 rounded-full shadow-xl hover:shadow-2xl transition-all duration-500 group-hover:scale-105">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-bold bg-gradient-to-r from-rose-600 to-violet-600 bg-clip-text text-transparent">
        ...
        <div className="text-center mb-4 relative">
          <h1 className="text-3xl sm:text-6xl lg:text-7xl xl:text-4xl font-black tracking-tight mb-3 leading-none">
            <span className="block mb-2 bg-gradient-to-r from-slate-900 via-gray-800 to-slate-900 bg-clip-text text-transparent">
        ...
        <div className="text-center mb-12 max-w-4xl">
          <p className="text-xl sm:text-2xl lg:text-xl text-gray-600 font-medium leading-relaxed mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            {[
              ...
              <div
                key={item.text}
                className="group flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-white/40 rounded-full px-4 py-2 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
