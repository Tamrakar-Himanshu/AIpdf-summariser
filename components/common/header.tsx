    ...
    <nav className="container flex items-center justify-between py-4 lg:px-8 px-2 mx-auto relative">
      ...
      <div className="hidden lg:flex justify-end flex-1">
        <div className="flex gap-2 items-center font-extrabold">
          <SignedIn>
            <NavLink href={"/upload"} className="px-3">Upload</NavLink>
      ...
      <div className="lg:hidden flex items-center">
        <button
          ...
          className="p-2 rounded-md focus:outline-none bg-white"
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="absolute top-full left-0 w-full bg-white shadow-md z-50 flex flex-col gap-4 px-4 py-6 lg:hidden font-bold">
